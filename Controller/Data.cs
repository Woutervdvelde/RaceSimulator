...
namespace Controller
{
    public static class Data
    {
        ...
        public static void AddParticipants()
        {
            ...
            Competition.Participants.Add(new Driver("MaineCoon", new Car(), TeamColors.Green));
